    ...
    <div id="top" className="min-h-screen text-black" style={{ background: THEME.cream }}>
      ...
      <div className="relative">
        ...
        <header className="relative">
          ...
          <AmbientSection bgImage={SECTION_BACKGROUNDS.hero} className="mx-auto max-w-6xl rounded-[2rem]">
            <div className="px-4 pb-10 pt-12 sm:px-6 sm:pt-16 lg:px-8">
              <div className="mb-6 inline-flex items-center gap-2 rounded-3xl border border-black/10 bg-white/80 px-4 py-2 text-black/80 backdrop-blur">
              ...
              >
                ...
                <div className="lg:col-span-7">
                  <div className="inline-flex flex-wrap gap-2 rounded-2xl bg-white/80 p-2 backdrop-blur">
                  ...
                  <h1 className="mt-5 font-serif text-4xl font-semibold tracking-tight text-black drop-shadow-[0_8px_22px_rgba(255,255,255,0.65)] sm:text-6xl">
                    {WEDDING.couple}
                  </h1>

                  <p className="mt-4 text-lg text-black/80 drop-shadow-[0_6px_18px_rgba(255,255,255,0.60)] sm:text-xl">
                    We’re getting married at a maple syrup farm with a big tent, barn doors, and views for days. Nature
                    is invited. Mosquitoes are not.
                  </p>
                  ...
                  <div className="mt-8 inline-flex flex-wrap items-center gap-3 rounded-2xl bg-white/80 p-3 text-sm text-black/75 backdrop-blur drop-shadow-[0_6px_18px_rgba(255,255,255,0.60)]">
        ...
        <div className="py-10">
          ...
          <Section id="schedule" title="Schedule" kicker="How the day flows" icon={Clock}>
            <div className="grid gap-4 lg:grid-cols-3">
              <Card>
                <div className="text-base font-semibold">4:00 PM</div>
              ...
              <Card>
                <div className="text-base font-semibold">6:00 PM</div>
        ...
        {/* GALLERY */}
        <AmbientSection bgImage={SECTION_BACKGROUNDS.photos} className="py-10">
          <RusticDivider />
        ...
        {/* TRAVEL */}
        <AmbientSection bgImage={SECTION_BACKGROUNDS.travel} className="py-10">
          <RusticDivider />
        ...
        {/* RSVP */}
        <AmbientSection bgImage={SECTION_BACKGROUNDS.rsvp} className="py-10">
          <RusticDivider />
